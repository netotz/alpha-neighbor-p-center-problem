...
public class PdpConstructivesExperiment
{
    ...
    /// </summary>
    public List<PdpResult<OriginalGreedyDispersion<InstanceSameSet>>> OgdResults
    { get; private set; } = [];
    /// <summary>
    /// Results of Fast Greedy Dispersion (FGD).
    /// </summary>
    public List<PdpResult<FastGreedyDispersion<InstanceSameSet>>> FgdResults
    { get; private set; } = [];
    ...
    public void Run()
    {
        ...
        foreach (var instance in Instances)
        {
            ...
            foreach (var pFrac in PFractions)
            {
                ...
                var fgd = new FastGreedyDispersion<InstanceSameSet>(instance, p, Seed);
                ...
                var ogd = new OriginalGreedyDispersion<InstanceSameSet>(instance, p, Seed);
